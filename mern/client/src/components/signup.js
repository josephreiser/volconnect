...
export default function SignUp({event}) {
 ...
 async function onSubmit(e) {
   ...
   console.log(attendee)
    /*
   axios.get('http://localhost:30001/users/verify', JSON.stringify(attendee), 
   { 
       headers: {
   ...
   axios.post('http://localhost:30001/events/signup', JSON.stringify(attendee), 
   { 
       headers: {
            'content-type': "application/json",
            'Access-Control-Allow-Origin': '*',
   ...
   /
   await fetch("http://localhost:30001/events/create", {
     method: "POST",
     headers: {
       "Content-Type": "application/json",
     },

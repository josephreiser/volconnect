...
export default function ViewEvents() {
    ...
    async function onSubmit(e) {
        ...
        axios.post('http://129.114.25.172:5000/users/verify', JSON.stringify(attendee),
        {
            headers: {
        ...
        .then((response) => {
            if (response.data.password == attendee.password){
                ...
                axios.post('http://129.114.25.172:5000/events/update', JSON.stringify(comparator),
                {
                    headers: {
                        'content-type': "application/json",
                        'Access-Control-Allow-Origin': '*',
    ...
    if (displayed == false){ 
        axios.get('http://129.114.25.172:5000/events/view')
        .then((response) => {

...
export default function ManageEvent() {
 ...
 function submitAttendees(){
   ...
   axios.post('http://129.114.25.172:5000/users/update', JSON.stringify(myRequest),
   {
       headers: {
 ...
 async function onSubmit(e) {
   ...
   axios.post('http://129.114.25.172:5000/nonprofits/verify', JSON.stringify(admin),
        {
            headers: {
                'content-type': "application/json",
                'Access-Control-Allow-Origin': '*',
        ...
        .then((response) => {
          if (response.data.password == admin.password){
            ...
            axios.post('http://129.114.25.172:5000/events/find', JSON.stringify(body), 
            {
              headers: {
                  'content-type': "application/json",
                  'Access-Control-Allow-Origin': '*',
